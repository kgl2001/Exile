...
.background_objects_type
    ...
    equb &0d, &0d, &1f, &0d, &5c
    equb &0d
.background_objects_type_2
    equb &20,   5,   4,   6, &31,   5, &2a,   9, &0d, &0d, &1f, &20, &55, &55, &0d, &63
    equb &0f
.background_objects_type_3
    equb &2e, &0a, &1b, &37, &29, &1a, &1a, &37, &37, &0a, &37, &4b, &4b, &2d, &1f, &20
    equb &0d, &0d, &28, &55,   5, &80,   0, &80, &80, &20, &28, &0d, &0d, &28, &27, &31
    equb &0e,   8, &11, &39, &37, &37, &37, &2a, &80, &4a, &10, &2f, &30
    equb &30
.background_objects_type_4
    equb   9, &0d,   9,   9, &4f, &24, &4a,   4, &1a, &39, &10,   0, &4c, &0a, &2f, &29
    equb &2c, &37, &20, &3a, &0d,   5,   5, &0d, &20, &0d, &0d, &48, &51, &0c, &55, &22
    equb   4, &2e, &2f, &2b, &2a, &21,   2,   2, &1a, &80, &4b, &80
